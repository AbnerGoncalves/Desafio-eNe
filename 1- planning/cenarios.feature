...
Cenario: 4 - Validar o busca de um artigo com categoria existente
Dado que acessei o blog da ene soluções
...
Cenario: 5 - Validar o busca de um artigo com categoria não existente
Dado que acessei o blog da ene soluções
...
Cenario: 6 - Validar o tentaiva de busca, enviando vazio o campo de pesquisa
Dado que acessei o blog da ene soluções
...
Cenario: 7 - Validar a visualização da sessão de artigos em destado
Dado que acessei o blog da ene soluções
...
Cenario: 17 - Validar a existencia da barra de categorias
Dado que acessei o blog da ene soluções
E navego pela pagina
...
Cenario: 18 - Validar a visualização de Todos as Categorias, pela barra de categorias
...
Cenario: 19 - Validar a função do botão "Ver tudo", após selecioanar Todas as Categorias, pela barra de categorias
...
Cenario: 20 - Validar a visualização dos artigos de UI/UX, pela barra de categorias
Dado que estou na sessão da barra de categorias
Quando clico na opcão "UI/UX"
Então devo visualizar todos os artigos relacionados a UI/UX

Cenario: 21 - Validar o direcionamento para o artigo de UI/UX, pela barra de categorias
Dado que estou na sessão da barra de categorias
...
Cenario: 22 - Validar a visualização dos artigos de Outsourcing de TI, pela barra de categorias
Dado que estou na sessão da barra de categorias
Quando clico na opcão "Outsourcing de TI"
Então devo visualizar todos os artigos relacionados a Outsourcing de TI

Cenario: 23 - Validar o direcionamento para o artigo de Outsourcing de TI, pela barra de categorias
Dado que estou na sessão da barra de categorias
...
Cenario: 24 - Validar a visualização dos artigos de Inovação, pela barra de categorias
Dado que estou na sessão da barra de categorias
Quando clico na opcão "Inovação"
Então devo visualizar todos os artigos relacionados a Inovação

Cenario: 25 - Validar o direcionamento para o artigo de Inovação, pela barra de categorias
Dado que estou na sessão da barra de categorias
...
Cenario: 26 - Validar a visualização dos artigos de Mercado de TI, pela barra de categorias
Dado que estou na sessão da barra de categorias
Quando clico na opcão "Mercado de TI"
Então devo visualizar todos os artigos relacionados a Mercado de TI

Cenario: 27 - Validar o direcionamento para o artigo  de Mercado de TI, pela barra de categorias
Dado que estou na sessão da barra de categorias
...
Cenario: 32 - Validar a visualização dos artigos de Desenvolvimento, pela barra de categorias
Dado que estou na sessão da barra de categorias
Quando clico na opcão "Desenvolvimento"
Então devo visualizar todos os artigos relacionados a Desenvolvimento

Cenario: 33 - Validar o direcionamento para o artigo de Desenvolvimento, pela barra de categorias
Dado que estou na sessão da barra de categorias
...
Cenario: 34 - Validar a visualização dos artigos de Cases, pela barra de categorias
Dado que estou na sessão da barra de categorias
Quando clico na opcão "Cases"
Então devo visualizar todos os artigos relacionados a Cases

Cenario: 35 - Validar o direcionamento para o artigo de , pela barra de categorias
Dado que estou na sessão da barra de categorias
...
Cenario: 36 - Validar a existencia do campo de email, para a assinatura do Newsletter, no final da tela
Dado que acessei o blog da ene soluções 
E navego pela pagina
...
Cenario: 37 - Validar o preenchimento correto de um email.
...
Cenario: 38 - Validar o preenchimento incorreto de um email.
...
Cenario: 39 - Validar o não preenchimento de um email.
